...
import indexRoutes from './routes/url';

pool.query("CREATE TABLE IF NOT EXISTS users (id_user SERIAL PRIMARY KEY, name_user varchar(50) NOT NULL, username varchar(50) NOT NULL, password varchar(50) NOT NULL, acc_type TEXT NOT NULL, constraint check_acc_type check (acc_type in ('Male', 'Female')))");
