...
pool.query("CREATE TABLE IF NOT EXISTS urls_clicks (id_clicks SERIAL PRIMARY KEY, id_url INT NOT NULL references urls(id_url), fromTo varchar(25) NOT NULL, clicks INT NOT NULL)");
